    ...
    <div className="interactive-controls-section">
      <div className="countdown-control-buttons flex gap-sm items-center">
        ...
        <div className="hp-section">
          <div 
            className="hp-symbols flex gap-xs items-center cursor-pointer p-2px"
            onClick={(e) => {
              e.stopPropagation()
              e.preventDefault()
          ...
          >
            {Array.from({ length: item.hpMax || 1 }, (_, i) => (
              <span
                key={i}
                className={`pip-symbol cursor-pointer ${i < (item.hp || 0) ? 'filled' : 'empty'}`}
        ...
        {item.stressMax > 0 && (
          <div className="stress-section">
            <div 
              className="stress-symbols flex gap-xs items-center cursor-pointer p-2px"
              onClick={(e) => {
                e.stopPropagation()
                e.preventDefault()
            ...
            >
              {Array.from({ length: item.stressMax }, (_, i) => (
                <span
                  key={i}
                  className={`pip-symbol cursor-pointer ${i < (item.stress || 0) ? 'filled' : 'empty'}`}
        ...
        {item.difficulty && ((item.thresholds && item.thresholds.major && item.thresholds.severe) || item.type === 'Minion') && (
          <div className="difficulty-section flex items-center gap-sm">
            <div 
              onClick={(e) => {
                e.stopPropagation()
