...
const BottomBar = ({
  ...
  return (
    <nav className={`sidebar-nav`}>
      <button
        className={`btn-base btn-icon sidebar-nav-item ${isEditMode ? 'active' : ''}`}
      ...
      <div
        className={`sidebar-nav-item ${showMockup ? 'active' : ''} cursor-pointer`}
        onClick={(e) => {
          e.stopPropagation()
      ...
      <div
        className={`sidebar-nav-item ${deleteFlyoutOpen ? 'delete-active' : ''} ${!hasAnyItems ? 'disabled' : ''} ${!hasAnyItems ? 'cursor-not-allowed' : 'cursor-pointer'}`}
        onClick={(e) => {
          e.stopPropagation()
          if (hasAnyItems) {
      ...
      <div
        className={`sidebar-nav-item ${helpFlyoutOpen ? 'help-active' : ''} cursor-pointer`}
        onClick={(e) => {
          e.stopPropagation()
      ...
      >
        ...
        <div className={`flyout-menu ${helpFlyoutOpen ? 'show' : ''}`}>
          ...
          <div className="flyout-menu-item help-flyout-item cursor-default text-secondary">
            <div className="flex items-center justify-center gap-xs">
