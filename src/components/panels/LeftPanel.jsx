...
import CountdownsSection from '../game/CountdownsSection'
import EnvironmentsSection from '../game/EnvironmentsSection'
import AdversariesSection from '../game/AdversariesSection'
...
const LeftPanel = ({
  ...
  return (
    <PanelShell className="left-panel-shell">
      <CountdownsSection
