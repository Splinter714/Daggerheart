...
import DamageInputPopup from './DamageInputPopup'
import DragHandle from './DragHandle'
import CountdownSymbols from './CountdownSymbols'
import HealthSymbols from './HealthSymbols'
import { 
  getDefaultData, 
  getInitialData, 
  rollDice, 
  formatTriggerCondition, 
  parseCountdownDetails, 
  checkIfInteractive, 
...
const Cards = ({ 
  ...
  const [editData, setEditData] = useState(getInitialData(item, type))
